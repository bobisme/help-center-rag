...
def setup_container():
    ...
    from epic_rag.infrastructure.persistence.sqlite_repository import SQLiteDocumentRepository
    from epic_rag.infrastructure.embedding.qdrant_repository import QdrantVectorRepository
    
    # Register repositories
    container.register_factory("document_repository", lambda c: SQLiteDocumentRepository(
        db_path=settings.database.path,
        enable_json=settings.database.enable_json,
    ))
    
    container.register_factory("vector_repository", lambda c: QdrantVectorRepository(
    ...
    # Note: Additional service registrations will be added as we implement them