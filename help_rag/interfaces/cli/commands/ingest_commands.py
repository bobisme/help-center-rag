...
def load_documents_from_json(
    ...
    """Load documents from the scraped-docs.json file.
    ...
    """
    json_path = "output/scraped-docs.json"
...
def load_document_from_json(index: int) -> Document:
    """Load a single document from the scraped-docs.json file by index.
...
def print_document(
    index: int = typer.Option(
        ..., "--index", "-i", help="Document index in scraped-docs.json"
    )
):
    """Print the document at the specified index from scraped-docs.json."""
    ...
    console.print(
        Panel(
            ...
            f"Source Page ID: {document.source_page_id}\n"
...
def show_chunks(
    index: int = typer.Option(
        None, "--index", "-i", help="Document index in scraped-docs.json"
    ),
    ...
    """Show the chunks for documents from scraped-docs.json."""
    # Validate parameters
...
def embed_document(
    ...
    """Embed chunks for documents from scraped-docs.json and print vector information."""
    # Validate parameters
    if index is None and not (limit or all_docs or offset > 0):
        console.print(
            "[bold red]Error: Must specify either --index, --limit, --offset, or --all[/bold red]"
...
def run_pipeline(
    ...
    """Run the full ingestion pipeline for documents from scraped-docs.json.
