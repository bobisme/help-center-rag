...
async def main():
    ...
    parser.add_argument("--limit", "-l", type=int, default=20, help="Maximum number of documents to list")
    parser.add_argument("--offset", "-o", type=int, default=0, help="Offset to start listing from")
